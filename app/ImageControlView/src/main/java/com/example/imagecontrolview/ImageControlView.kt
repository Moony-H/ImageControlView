...
import com.example.imagecontrolview.databinding.SourceCustomImageControlViewBinding
import kotlin.math.*
...
class ImageControlView: ConstraintLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs){
        ...
        attrs?.let {
            ...
            this.mainImage.setImageResource(typeArray.getResourceId(R.styleable.ImageControlView_src,R.color.black))
            typeArray.recycle()
        }
